...
export default function ServiceProviderEnterPin({ route, navigation }) {
  ...
  const onVerify = () => {
    ...
    if (value == route.params.OTP || value == OTPcode) {
      ...
      route.params.routeDetails == 'FromPhoneLogin'
        ...
        : navigation.navigate('ServiceProviderChangePass', {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ alignSelf: 'center' }}>
        ...
        <Text style={{ fontSize: 16, color: colors.serviceProvider.primary, alignSelf: 'center' }}>
          Note:
        </Text>
        <Text
          style={{
