...
const CustomerSocialLogin = ({navigation}) => {
  ...
  useEffect(() => {
    ...
    GoogleSignin.configure({
      ...
      iosClientId:
        '905631795286-70b7fbjkc4btm2kahfl2lka7q19s0729.apps.googleusercontent.com', // [iOS] optional, if you want to specify the client ID of type iOS (otherwise, it is taken from GoogleService-Info.plist)
  ...
  const signInGoogle = async () => {
    try {
      ...
      googleData.append('type', 'customer');
    ...
    <>
      ...
      <View style={styles.container}>
        <View style={styles.allButtons}>
          ...
          <TouchableOpacity
            onPress={() =>
              navigation.navigate('CutomerPhoneLogin', {
                NotToken: NotificationToken,
              })
            }
            style={styles.buttonView}>
