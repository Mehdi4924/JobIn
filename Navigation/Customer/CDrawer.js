...
export default function CSideBar(props) {
  ...
  const OnLogOut = async () => {
    ...
    props.navigation.replace('CAuthNav');
  };
  const getUser = async () => {
      ...
      {userData != null || userData != undefined ? (
          ...
          <ScrollView
            ...
            <View style={{ marginVertical: hp(4) }}>
              ...
              <TouchableOpacity
                style={styles.tabstyle}
                onPress={() => {
                  props.navigation.navigate('AllServiceProviders', {
                    routeDetails: '',
                  });
                }}>
                <Icon
              ...
              <TouchableOpacity
                style={styles.tabstyle}
                onPress={() => {
                  props.navigation.navigate('CustomerAllChats');
                }}>
                <Icon
              ...
              <TouchableOpacity
                style={styles.tabstyle}
                onPress={() => {
                  props.navigation.navigate('DashboardChangePass');
                }}>
                <Icon
                  name="lock-outline"
                  type="material-community"
        ...
        <View style={styles.mainView}>
          <ScrollView
            ...
            <TouchableOpacity
              style={styles.tabstyle}
              onPress={() => props.navigation.replace('CAuthNav')}>
              <Icon
                name="logout-variant"
                type="material-community"
                color={colors.customer.secondary}
